...
export function StudioFAQ({ faqs }: StudioFAQProps) {
  ...
  return (
    <section className="py-20 lg:py-32 bg-[#f8f6f3]">
      <div className="container mx-auto px-6 lg:px-12">
        ...
        >
          <h2 className="mb-4">Studio Hire FAQs</h2>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Everything you need to know about booking and using our studio space.
          </p>
        </motion.div>
